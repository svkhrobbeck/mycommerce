...
export const styles: IStyles = {
  ...
  buttonPurple:
    "inline-block px-5 py-3 text-sm font-medium text-white bg-indigo-600 rounded hover:bg-indigo-700 focus:outline-none focus:ring",
  buttonYellow: "outline-none block w-full rounded bg-yellow-400 hover:bg-yellow-500 p-3 text-sm font-medium transition",
